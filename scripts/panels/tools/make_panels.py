...
MOD2 = {
 ...
 "mod2-tremolo":   M2("TREMOLO","Rate","Depth",B,"shape","lfo","Clock","Reset","In","Out"),
 "mod2-wavefolder":M2("WAVEFOLD","Fold","Symm",B,"curve","dens",B,"Byp","In","Out"),
 "mod2-filter":    M2("FILTER","Freq","Res",B,"mode","lvl",B,"Byp","In","Out"),
 "mod2-dynamics":  M2("DYNAMICS","Amount","Release",B,"mode","gr","Duck","Byp","In","Out"),
 "mod2-comb":      M2("COMB","Tune","Fdbk",B,"mode","ring",B,"Kill","In","Out"),
 "mod2-karplus":   M2("KARPLUS","Pitch","Damp",B,"mode","ring","Pluck","Damp","In","Out"),
 "mod2-freeze":    M2("FREEZE","Length","Pos",B,"mode","froz","Freeze","Recap","In","Out"),
 "mod2-stutter":   M2("STUTTER","Len","Behav",B,"flav","rpt","Clock","Gate","In","Out"),
 "mod2-reverse-delay":M2("REVERSE","Time","Fdbk",B,"mode","sweep","Clock","Flip","In","Out"),
 "mod2-glitch-delay": M2("GLITCH","Time","Chaos",B,"pal","glch","Clock","Force","In","Out"),
 "mod2-freq-shifter": M2("FREQSHIFT","Shift","Fdbk",B,"range","rot","Flip","Byp","In","Out"),
 "mod2-reverb":    M2("REVERB","Size","Decay",B,"mode","tail",B,"Freeze","In","Out"),
 "mod2-granular":  M2("GRANULAR","Size","Texture",B,"char","grain","Trig","Freeze","In","Out"),
