...
struct RandomCVWidget : ModuleWidget {
	RandomCVWidget(RandomCV* module) {
		...
		addParam(createParamCentered<Reversed<RoundBlackKnob>>(mm2px(Vec(10.03f, 21.7f)), module, RandomCV::STEPS_PARAM));
		addParam(createParamCentered<Reversed<RoundBlackKnob>>(mm2px(Vec(10.04f, 40.06f)), module, RandomCV::LEVEL_PARAM));
		addParam(createParamCentered<Reversed<RoundBlackKnob>>(mm2px(Vec(10.04f, 58.42f)), module, RandomCV::PROB_PARAM));
