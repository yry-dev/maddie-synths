...
struct TerrainLFOWidget : ModuleWidget {
	TerrainLFOWidget(TerrainLFO* module) {
		...
		addParam(createParamCentered<Reversed<RoundBlackKnob>>(mm2px(Vec(10.03f, 21.7f)), module, TerrainLFO::SPEED_PARAM));
		addParam(createParamCentered<Reversed<RoundBlackKnob>>(mm2px(Vec(10.04f, 40.06f)), module, TerrainLFO::SLOMO_PARAM));
		addParam(createParamCentered<Reversed<RoundBlackKnob>>(mm2px(Vec(10.04f, 58.42f)), module, TerrainLFO::KNOTS_PARAM));
