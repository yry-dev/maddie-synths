...
/*
	...
	Port of firmwares/mod1-euclidean/mod1-euclidean.ino, HAGIWO's CC0 1.0 firmware;
...
struct EuclideanWidget : ModuleWidget {
	EuclideanWidget(Euclidean* module) {
		setModule(module);
		setPanel(createPanel(asset::plugin(pluginInstance, "res/mod1-euclidean.svg")));
		// 4 HP Mod1/Mod2 panel — real hole centres (scripts/panels/tools/panel_map.py).
		addChild(createWidget<ScrewSilver>(Vec(box.size.x / 2 - RACK_GRID_WIDTH / 2, 0)));
		addChild(createWidget<ScrewSilver>(Vec(box.size.x / 2 - RACK_GRID_WIDTH / 2, RACK_GRID_HEIGHT - RACK_GRID_WIDTH)));

		addParam(createParamCentered<Reversed<RoundBlackKnob>>(mm2px(Vec(10.03f, 21.7f)), module, Euclidean::HITS_PARAM));
		addParam(createParamCentered<Reversed<RoundBlackKnob>>(mm2px(Vec(10.04f, 40.06f)), module, Euclidean::PROB_PARAM));
...
Model* modelEuclidean = createModel<Euclidean, EuclideanWidget>("mod1-euclidean");
