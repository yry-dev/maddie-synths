...
struct ClavesWidget : ModuleWidget {
	ClavesWidget(Claves* module) {
		setModule(module);
		setMod2Panel(this, module, "res/mod2-claves.svg");
		...
		addParam(createParamCentered<Reversed<RoundBlackKnob>>(mm2px(Vec(10.03f, 21.70f)), module, Claves::DECAY_PARAM));
		addParam(createParamCentered<Reversed<RoundBlackKnob>>(mm2px(Vec(10.04f, 40.06f)), module, Claves::WAVE_PARAM));
		addParam(createParamCentered<Reversed<RoundBlackKnob>>(mm2px(Vec(10.04f, 58.42f)), module, Claves::PITCH_PARAM));
...
Model* modelClaves = createModel<Claves, ClavesWidget>("mod2-claves");
